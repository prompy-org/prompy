...
export default function GoogleLogin({ onLoginSuccess }) {
  ...
  const handleGoogleLogin = () => {
    ...
    window.location.href = `${process.env.ENV === 'PROD' ? process.env.NEXT_PUBLIC_PROD_API_URL : process.env.NEXT_PUBLIC_DEV_API_URL}/api/auth/google/web?state=${state}&redirect_url=${encodeURIComponent(`${origin}/auth/callback`)}`;
  };
